...
path = 'C:\Learning\Computer Science\Machine Learning\\03 My Projects\\02 Codes\\01 BinaryClassification\My_Learning_PyTorch_FCNN_BinaryClassification\MyProject_Stats_PyTorch_BinaryClassification_Churn_ANN_01\Churn_Modelling.csv'
...
def train(model, train_inputs, train_labels, test_inputs, test_labels, batch_size, num_epochs, criterion, optimizer):
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch = {epoch + 1} ===> Loss = {total_loss: .3f} ===> Time = {epoch_time: .3f} ===> Test Accuracy = {test_accuracy: .4f} ===> Best Accuracy = {best_accuracy: .4f} at Epoch {best_epoch}")
    ...
    print(f"\nThe Accuracy of the Final Models is: {final_accuracy}")
