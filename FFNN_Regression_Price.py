...
path = 'C:\Learning\Computer Science\Machine Learning\\03 My Projects\\01 Datasets\\03 Regression\insurance.csv'
...
print("\nThe prediction is: " + str(sc.inverse_transform(prediction_01.detach()).item()) + " --- The true is: 16884.92400" + " --- So the difference is: " + str(sc.inverse_transform(prediction_01.detach()).item() - 16884.92400))

prediction_02 = ffnn(torch.FloatTensor(scaler.transform([[0, 1, 0, 0, 60, 0, 25.84, 0, 0]])))
print("\nThe prediction is: " + str(sc.inverse_transform(prediction_02.detach()).item()) + " --- The true is: 28923.13692" + " --- So the difference is: " + str(sc.inverse_transform(prediction_02.detach()).item() - 28923.13692))

prediction_03 = ffnn(torch.FloatTensor(scaler.transform([[1, 0, 0, 0, 37, 1, 29.83, 2, 0]])))
print("\nThe prediction is: " + str(sc.inverse_transform(prediction_03.detach()).item()) + " --- The true is: 6406.41070" + " --- So the difference is: " + str(sc.inverse_transform(prediction_03.detach()).item() - 6406.41070))
