...
def train(model, train_inputs, train_labels, test_inputs, test_labels, batch_size, num_epochs, criterion, optimizer):
    ...
    for epoch in range(num_epochs):
        ...
        # Compute the model's accuracy on validation set and record the model's weights corresponding to the best validation accuracy
        ...
        print(f"Epoch = {epoch + 1} ===> Loss = {total_loss: .3f} ===> Time = {epoch_time: .3f} ===> Validation Accuracy = {validation_accuracy: .4f} ===> Best Accuracy = {best_accuracy} at epoch {best_epoch}")
